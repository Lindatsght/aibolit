...
define('PASS', '100554'); // пароль для запуска
...
$g_JSVirSig = unserialize(base64_decode(""));

////////////////////////////////////////////////////////////////////////////
define('AI_VERSION', '20120702');
...
function QCR_GoScan($par_Offset)
{
	global $g_Iframer, $g_SuspDir, $g_Redirect, $g_Doorway, $g_EmptyLink, $g_Structure, $g_Counter, 
		   ...
		   $g_NotRead, $g_WarningPHPFragment, $g_BigFiles, $g_RedirectPHPFragment, $g_EmptyLinkSrc;
...
function WarningPHP($l_FN, $l_Content, &$par_Pos)
{
  ...
  foreach ($g_SusDB as $l_Item)
  {
	...
	stripos($l_Content, 'YFDSEEEERYUNHGGFFDDJHG7') === false) {
...
function Adware($l_FN, $l_Content)
{
  ...
  {
    if (stripos($l_Content, $l_Item) && !stripos($l_Content, 'YFDSEEEERYUNHGGFFDDJHG7')) {
       $l_Res = true;
       break;
    }
  }
...
function CriticalPHP($l_FN, $l_Index,  $l_Content)
{
  ...
  if (preg_match('|([A-Za-z0-9+/]{' . BASE64_LENGTH . ',})|smi', $l_Content, $l_Found)
	...
	&& !stripos($l_Content, 'YFDSEEEERYUNHGGFFDDJHG7')) {
     $g_Base64[] = $l_Index;
  }
...
if (count($g_CriticalPHP) > 0) {
  ...
  $l_Result .= printList($g_CriticalPHP, '', true);
  $l_Result .= "</div>";
...
if (count($g_Base64) > 0) {
  ...
  $l_Result .= printList($g_Base64, '', true);
  $l_Result .= "</div>";
