...
define('PASS', '129'); // пароль для запуска

$defaults = array(
	'path' => dirname(__FILE__),
	'scan_all_files' => 1, // полное сканирование файлов (не только .js, .php, .html, .htaccess)
	...
	'site_url' => 'http://сайт/', // адрес вашего сайта
	'no_rw_dir' => 0
);

// завернутые сигнатуры, чтобы не ругались антивирусы на PC и на хостинге
$g_DBShe = unserialize(base64_decode(""));
$g_SusDB = unserialize(base64_decode(""));
...
$g_JSVirSig = unserialize(base64_decode(""));

////////////////////////////////////////////////////////////////////////////
define('AI_VERSION', '20120623');
...
if (!isCli()) {
   $defaults['site_url'] = 'http://' . $_SERVER['HOST'] . '/'; 
}
...
// forcibly scan all files when running from command line
if (isCli()) {
  $defaults['scan_all_files'] = 1;
}
...
function needIgnore($par_FN, $par_CRC) {
  ...
  for ($i = 0; $i < count($g_IgnoreList); $i++) {
     if (strpos($par_FN, $g_IgnoreList[$i][0]) >= 0) {
...
function printList($par_List, $par_Details = null) {
  ...
  for ($i = 0; $i < count($par_List); $i++) {
	...
	if (needIgnore($g_Structure['n'][$par_List[$i]], $g_Structure['crc'][$l_Pos])) {
     ...
     $l_Creat = $g_Structure['c'][$l_Pos] > 0 ? date("d/m/Y H:i", $g_Structure['c'][$l_Pos]) : '-';
     $l_Modif = $g_Structure['m'][$l_Pos] > 0 ? date("d/m/Y H:i", $g_Structure['m'][$l_Pos]) : '-';
...
function QCR_GoScan($par_Offset)
{
	global $g_Iframer, $g_SuspDir, $g_Redirect, $g_Doorway, $g_EmptyLink, $g_Structure, $g_Counter, 
		   ...
		   $g_WarningPHPFragment, $g_BigFiles, $g_RedirectPHPFragment, $g_EmptyLinkSrc;
	...
	for ($i = $par_Offset; $i < $g_Counter; $i++)
	{
		...
		else
		{
			...
			else
			{
				...
				// critical
				if (CriticalPHP($l_Filename, $i, $l_Unwrapped))
				{
					$g_CriticalPHP[] = $i;
				}
				...
				)
				{
					...
					if (preg_match_all('|<a[^>]+href[^>]+>(.*?)</a>|smiu', $l_Unwrapped, $l_Found, PREG_SET_ORDER))
					{
						for ($kk = 0; $kk < count($l_Found); $kk++) {
							if (trim(strip_tags($l_Found[$kk][1])) == '') {
							    $g_EmptyLink[] = $i;
				...
				if ((stripos($l_Filename, '.php') === false) && (stripos($l_Filename, '.phtml') === false))
				{
...
function WarningPHP($l_FN, $l_Content, &$par_Pos)
{
  ...
  foreach ($g_SusDB as $l_Item)
  {
	...
	stripos($l_Content, 'YYAFAFDGD23423453567777') === false) {
...
function Adware($l_FN, $l_Content)
{
  ...
  {
    if (stripos($l_Content, $l_Item) && !stripos($l_Content, 'YYAFAFDGD23423453567777')) {
       $l_Res = true;
       break;
    }
  }
...
function CriticalPHP($l_FN, $l_Index,  $l_Content)
{
  ...
  if (preg_match('|([A-Za-z0-9+/]{' . BASE64_LENGTH . ',})|smi', $l_Content, $l_Found)
	...
	&& !stripos($l_Content, 'YYAFAFDGD23423453567777')) {
     $g_Base64[] = $l_Index;
  }
...
if (!isCli()) {
  ...
  if (!($_GET['p'] == PASS || $_GET['ph'] == crc32(PASS))) {
...
if ($l_ShowOffer) {
  print '<div class="offer">' .
        ...
        'Если скрипт оказался вам полезен, <br>пожалуйста, <a href="http://revisium.com/ai/others.php"><b>поддержите проект материально</b></a>. Спасибо.' .
        '</div>';
}
