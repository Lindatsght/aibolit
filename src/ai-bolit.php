		...
		else
		{
			...
			else
			{
				...
				)
				{
					...
					// check empty links
					if (preg_match_all('|<a.+?>\s*</a>|smiu', $l_Unwrapped, $l_Found, PREG_SET_ORDER))
					{
						$g_EmptyLink[] = $i;
