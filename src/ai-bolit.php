...
define('PASS', '121524'); // пароль для запуска
...
function WarningPHP($l_FN, $l_Content, &$par_Pos)
{
  ...
  if (stripos($l_Content, 'YFDFDSQWE3RYUNHGGFFDDJHG7') !== false) {
     return $l_Res;
  }
...
function Adware($l_FN, $l_Content)
{
  ...
  if (stripos($l_Content, 'YFDFDSQWE3RYUNHGGFFDDJHG7')) {
     return $l_Res;
  }
...
function CriticalPHP($l_FN, $l_Index, $l_Content, &$l_Pos)
{
  ...
  // YFDFDSQWE3RYUNHGGFFDDJHG7
  $l_Res = false;

  if (strpos($l_Content, 'YFDFDSQWE3RYUNHGGFFDDJHG7') !== false) {
     return $l_Res;
  }
